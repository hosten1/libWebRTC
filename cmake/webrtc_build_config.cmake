...
# ==================== 平台检测 ====================
# 扩展 POSIX 平台支持：Linux, Android, macOS, iOS, FreeBSD, OpenBSD, NetBSD, Fuchsia, Emscripten (WASM)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin|Android|iOS|FreeBSD|OpenBSD|NetBSD|Fuchsia|Emscripten")
    set(IS_POSIX TRUE)
else()
    set(IS_POSIX FALSE)
endif()
