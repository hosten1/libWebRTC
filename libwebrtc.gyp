{
    # "variables": {
    #     "node_byteorder": "<!(uname -m | grep -q '64' && echo 'little' || echo 'big')",
    # },
    "target_defaults": {
        "dependencies": [
        ...
        #     ],
        # ],
        "direct_dependent_settings": {"include_dirs": [".", "libwebrtc"]},
        "sources": [
            # C++ source files.
        ...
        "conditions": [
            ...
            [
                'OS == "mac"',
                {
                    ...
                    "cflags_cc": ["-DWEBRTC_MAC", "-DWEBRTC_POSIX"],
                    "xcode_settings": {
                        ...
                        "OTHER_CPLUSPLUSFLAGS": [
                            "-std=c++11",
                            "-isystem deps/abseil-cpp/abseil-cpp",
                            "-I.",
                        ],
                        ...
                        "HEADER_SEARCH_PATHS": [
                            "$(inherited)",
                            "$(SRCROOT)/deps/abseil-cpp/abseil-cpp",
                            "$(SRCROOT)/deps/jsoncpp/jsoncpp/include",
                            "$(SRCROOT)/deps/libuv/include",
                            "$(SRCROOT)/deps/openssl/openssl/include",
                            "$(SRCROOT)/deps/json/single_include/nlohmann",
                        ],
                    },
                },
            ],
    ...
    "targets": [{"target_name": "libwebrtc", "type": "static_library"}],
}
